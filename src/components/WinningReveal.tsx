...
function WinningReveal({ winningNumbers, tickets, winAmounts }: WinningRevealProps) {
    ...
    <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          ...
          <div
            className="w-12 h-12 rounded-full bg-red-600 text-white flex items-center justify-center font-bold text-xl"
          >
      ...
      <div className="text-center">
        {totalWinnings > 0 ? (
          <div className="bg-green-600/20 p-4 rounded-lg">
            ...
            <p className="text-xl mb-4">Total Winnings: ${totalWinnings.toLocaleString()}</p>
            <p className="text-lg">
              {winningTickets.length} winning {winningTickets.length === 1 ? 'ticket' : 'tickets'}
            </p>
          </div>
        ) : (
